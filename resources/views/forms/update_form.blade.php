        ...
        <form action="{{ route('evenement.update',['evenement'=>$evenement->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <div
                ...
                <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false"
                    placeholder="Libelle de l'Evenement..." value="{{ $evenement->libelle }}" type="text" name="libelle">

                {{-- Date de limite l'Inscription --}}
                <label class="text-gray-600 dark:text-gray-400 mb-2">Date de limite des Inscriptions
                </label>
                <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false"
                    placeholder="Date limite des Inscription" type="date" value="{{ $evenement->date_limite_inscription }}" name="date_limite_inscription">
                ...
                <textarea class="description bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none"
                    ...
                    name="description">{{ $evenement->description }}</textarea>
                ...
                <select id="" class="bg-gray-100 border border-gray-300 p-2 mt-2  outline-none"
                    ...
                    <option selected class="text-slate-400" aria-placeholder="">{{ $evenement->est_cloture_ou_pas }}</option>
                    <option value="cloture">Occupe</option>
                    <option value="pas cloture">En Cours</option>
                </select>

                {{-- Date de l'evenement --}}
                <input class="title bg-gray-100 border border-gray-300 p-2 my-4 outline-none" spellcheck="false"
                    type="date" name="date_evenement" value="{{ $evenement->date_evenement }}">
