                ...
                <form method="POST" action="{{ route('create.user') }}">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input id="firstName" name="firstName" placeholder="Fist Name" type="text" required value=""
                    ...
                    <div class="mt-6">
                        <label for="lastName" class="block text-sm font-medium leading-5  text-gray-700">Name</label>
                        <div class="mt-1 relative rounded-md shadow-sm">
